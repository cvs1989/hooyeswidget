...
print <<<EOT
-->
	<a href='$Mdomain/member/?main=homepage_ctrl.php?atn=postnews&uid=$uid&id=$id' target='_blank'>编辑</a> | <a href='$Mdomain/member/?main=homepage_ctrl.php?atn=delnews&uid=$uid&id=$id' target='_blank'>删除</a> 
<!--
EOT;
}
print <<<EOT
