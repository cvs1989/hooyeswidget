...
class uc_note {
	...
	function synlogin($get, $post) {
		...
		//登录
		//global $onlineip;
		//setcookie("DZname",mymd5("$get[uid]\t$get[username]\t$onlineip"),time()+3600,'/');
		//echo "$get[uid]\t$get[username]\t$onlineip";
		//echo mymd5("$get[uid]\t$get[username]\t$onlineip");
