...
if($action=='mod'){
	...
	$SQL=" SELECT M.$TB[username] AS title,D.*,D.icon AS picurl,D.introduce AS content FROM $TB[table] M LEFT JOIN {$pre}memberdata D ON M.$TB[uid]=D.uid $SQL ORDER BY D.$order $asc LIMIT $rows ";
