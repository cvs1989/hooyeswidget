...
<div class="tdare">
  <table width="100%" cellspacing="0" class="dataTable">
    ...
    <tr class="tatr1">
      ...
      <td>企业联系人用户名 | 企业联系人姓名</td>
      <td><span ectype="order_by" fieldname="store_name">企业名称</span></td>
...
?>
  ...
  <div id="dataFuncs">
    ...
    <div id="batchAction" class="left paddingT15"><?php if (! $_GET['wait_verify']): ?>
      &nbsp;&nbsp;
      <input class="formbtn batchButton" type="button" value="编辑" name="id" uri="index.php?app=store&act=batch_edit" />
      &nbsp;&nbsp;
      <input class="formbtn batchButton" type="button" value="删除" name="id" uri="index.php?app=store&act=drop" presubmit="confirm('您确定要删除所选企业的所有信息（包括产品、订单等）吗？');" />
      <!--&nbsp;&nbsp;
