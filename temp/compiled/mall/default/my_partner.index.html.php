                ...
                <table class="table_head_line">
                    ...
                    <tr class="line_bold">
                        ...
                        <th class="align1" colspan="5">
                            ...
                            <a href="#" class="delete" uri="index.php?app=my_partner&act=drop" name="id" presubmit="confirm('您确定要删除它吗？')" ectype="batchbutton">删除</a>
                        </th>
                    </tr>
                    <tr class="gray">
                        <th></th>
...
?>
                    <?php if (($this->_foreach['v']['iteration'] == $this->_foreach['v']['total'])): ?><tr class="line_bold"><?php else: ?><tr class="line"><?php endif; ?>
                        ...
                        <td class="width13">
                        <div class="">
                            <a href="#" uri="index.php?app=my_partner&amp;act=edit&partner_id=<?php echo $this->_var['partner']['partner_id']; ?>" dialog_id="my_partner_edit" dialog_title="编辑" dialog_width="460" ectype="dialog" class="edit1">编辑</a><a href="javascript:drop_confirm('您确定要删除它吗？', 'index.php?app=my_partner&amp;act=drop&id=<?php echo $this->_var['partner']['partner_id']; ?>');" class="delete">删除</a>
                        </div>
                        </td>
                    </tr>
                    <?php endforeach; else: ?>
