        ...
        <div class="wrap">
            <div class="wrap_child">
                ...
                <div class="module_new_shop">
                    ...
                    <div class="chart">
                        <div class="pos_x1 bg_a2" title="1. 选择企业类型"></div>
                        <div class="pos_x2 bg_b1" title="2. 填写企业联系人和企业信息"></div>
...
?>
                            <tr>
                                ...
                                <td class="padding1 width5">
                                    <p>产品数: <span class="fontColor1"><?php echo $this->_var['sgrade']['goods_limit']; ?></span></p>
