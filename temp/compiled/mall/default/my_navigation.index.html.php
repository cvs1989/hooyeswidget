            ...
            <table class="table_head_line">
                ...
                <tr class="line_bold">
                    ...
                    <th class="align1" colspan="4">
                        ...
                        <a href="#" class="delete" ectype="batchbutton" uri="index.php?app=my_navigation&act=drop" name="nav_id" presubmit="confirm('您确定要删除它吗？')">删除</a>
                    </th>
                </tr>
                <tr class="gray">
                    <th></th>
