...
?>
                            ...
                            <li><a href="javascript:void(0);" title="<?php echo $this->_var['row']['region_id']; ?>"><?php echo htmlspecialchars($this->_var['row']['region_name']); ?></a> (<?php echo $this->_var['row']['count']; ?>)</li>
                            <?php else: ?>
                            <li style="display:none"><a href="javascript:void(0);" title="<?php echo $this->_var['row']['region_id']; ?>"><?php echo htmlspecialchars($this->_var['row']['region_name']); ?></a> (<?php echo $this->_var['row']['count']; ?>)</li>
                            <?php endif; ?>
                            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                        </ul>
                    </div>
...
?>
    ...
    foreach ($_from AS $this->_var['row']):
?>
                        <li><a href="javascript:void(0);" title="<?php echo $this->_var['row']['region_id']; ?>"><?php echo htmlspecialchars($this->_var['row']['region_name']); ?> (<?php echo $this->_var['row']['count']; ?>)</a></li>
                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                    </ul>
                </div>
                <?php endif; ?>
...
?>
                    <li>
                        ...
                        <h3>
                            <span class="text_link">
                                ...
                                <span class="info">
                                    <span>企业名称: <?php echo htmlspecialchars($this->_var['goods']['store_name']); ?></span>
                ...
                <?php else: ?>
                <div id="no_results">很抱歉! 没有找到相关产品</div>
                <?php endif; ?>
            </div>
        </div>
    ...
    <div class="module_common">
        <p class="no_info">很抱歉! 没有找到相关产品</p>
    </div>
    <?php endif; ?>
</div>
