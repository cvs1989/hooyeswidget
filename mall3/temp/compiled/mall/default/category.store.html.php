...
?>
                        <li>
                            ...
                            <dl>
                                ...
                                <dd>企业联系人:<?php echo htmlspecialchars($this->_var['store']['user_name']); ?></dd>
                                <dd>产品:<?php echo $this->_var['store']['goods_count']; ?></dd>
...
?>
    ...
    <div class="right">
        <div class="module_sidebar">
            <h2><b class="gategory" title="CATEGORY企业分类"></b></h2>
            <div class="wrap">
                <div class="wrap_child">
                    <div class="recommend">
