        ...
        <div class="wrap_line margin1" style="display:none">
            <div class="public_index">
                <div class="information_index">
                    ...
                    <?php else: ?>
                    <div class="awoke">
                        您目前还没有已生成的订单<br />去<a href="index.php">商城首页</a>，挑选喜爱的产品，体验购物乐趣吧。
                    </div>
                    <?php endif; ?>
                </div>
        ...
        <div class="wrap_line">
            <div class="public_index">
                <div class="information_index">
                    <h3 class="title">企业提醒
                        <p>
                        <span>企业等级: <?php echo $this->_var['sgrade']['grade_name']; ?></span>
                        <span>有效期: <?php if ($this->_var['sgrade']['add_time']): ?><?php echo sprintf('剩余 %s 天', $this->_var['sgrade']['add_time']); ?><?php else: ?>不限制<?php endif; ?></span>
                        <span>产品发布: <?php echo $this->_var['sgrade']['goods']['used']; ?>/<?php if ($this->_var['sgrade']['goods']['total']): ?><?php echo $this->_var['sgrade']['goods']['total']; ?><?php else: ?>不限制<?php endif; ?></span>
                    ...
                    <div class="remind">
                        ...
                        <a href="<?php echo url('app=store&id=' . $this->_var['store']['store_id']. ''); ?>" title="查看我的企业" target="_blank" class="btn1 pos2"><span class="pic2">查看我的企业</span></a>
