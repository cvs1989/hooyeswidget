        <div class="user">
            <div class="user_photo">
                ...
                <p><a href="javascript:collect_store(<?php echo $this->_var['store']['store_id']; ?>)">收藏该企业</a></p>
            </div>
            
            <div class="user_data">
                <p>
                    <span>企业联系人: </span><?php echo htmlspecialchars($this->_var['store']['store_owner']['user_name']); ?>
                ...
                <p>企业等级: <?php echo $this->_var['store']['sgrade']; ?></p>
                <p>产品数量: <?php echo $this->_var['store']['goods_count']; ?></p>
...
?>
                        ...
                        <a href="<?php echo url('app=article&act=system&code=cert_material'); ?>" target="_blank" title="实体企业"><img src="<?php echo $this->res_base . "/" . 'images/cert_material.gif'; ?>" /></a>
                        <?php endif; ?>
        ...
        <div class="module_common">
            <h2 class="common_title veins1">
                <div class="ornament1"></div>
                <div class="ornament2"></div>
                <span class="ico1"><span class="ico2">产品分类</span></span>
            </h2>
            <div class="wrap">
                <div class="wrap_child">
                    <ul class="submenu">
                        <li><a class="none_ico" href="<?php echo url('app=store&id=' . $this->_var['store']['store_id']. '&act=search'); ?>">全部产品</a></li>
