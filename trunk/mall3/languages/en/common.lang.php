...
return array(
    'chinese'=>'中文',
	'english'=>'English',
    'tip_1'=>'Free registration issued enterprise, product, supply and demand information',
    'username'  =>  '用户名',
    'password'  =>  '密&nbsp;&nbsp;&nbsp;码',
    'captcha'   =>  '验证码',
    'index'     =>  '首页',
    ...
    'not_storeadmin'    => '您还没有申请企业，无权访问页面。',
    'apply_now' => '立即申请开店',
    'no_permission'     => '您没有被授予相应的权限，无权访问',
    'apply_not_agree'   => '您的企业尚未开通，我们会尽快处理您的申请。',
    'store_is_closed'   => '您的企业已被关闭，请联系网站管理员开通。',
    'the_store_is_closed' => '该企业已被关闭，请稍后再访问。',
    'has_login'         => '您已经登录了',
    'cart'              => '购物车',
    'store_goods'       => '企业产品',
    'quantity'          => '数量',
    ...
    'export' => '导出',
    'import' => '导入',
    'note_for_export' => '您企业的数据是以 utf-8 编码存储的，导出时是否需要把数据转换为 %s 编码？',
    ...
    'ecmall_sysmsg' => '系统信息',
    'page_close'   => '关闭页面',
    'the_store_not_exist' => '该企业不存在，请核实后再访问',
    'subdomain' => '二级域名',
    'function_limit'    => '附加功能',
    'bat_upload' => '批量上传',
    'uploaded_files' => '已传图片',
    ...
    'uploadedfile' => '上传文件',
    'close_store_notice' => '关闭企业通知',
    'your_store_is_closed' => '您的企业已被关闭，原因是：%s',
    'close_reason' => '企业已到期',
    ...
    'nav_groupbuy'  => '团购活动',
    'sku'   => '货号',
    'not_support_function' => '很抱歉，您的企业等级不支持该附加功能，如需升级企业等级，请联系管理员。',
    'view_detail' => '，<a target="_blank" href="%s">查看详情</a>',
    'feed_order_created' => array(
        'title'     => '{actor} 在企业 {store} 购买了产品',
        'body'      => '',
        'name'      => '订单生成',
    ),
    'feed_store_created'    => array(
        'title'     => '{actor} 在 {mall_name} 开通了企业 {store}',
        'body'      => '',
        'name'      => '企业开通',
    ),
    'feed_goods_created'    => array(
        'title'     => '{actor} 添加了产品 {goods}',
        'body'      => '',
        'name'      => '添加产品',
    ),
    ...
    'feed_goods_collected'    => array(
        'title'     => '{actor} 收藏了产品 {goods}',
        'body'      => '',
        'name'      => '收藏产品',
    ),
    'feed_store_collected'    => array(
        'title'     => '{actor} 收藏了企业 {store}',
        'body'      => '',
        'name'      => '收藏企业',
    ),
    'feed_goods_evaluated'    => array(
        'title'     => '{actor} 给了产品 {goods} {evaluation}',
        'body'      => '评价：{comment}',
        'name'      => '评价产品',
    ),
