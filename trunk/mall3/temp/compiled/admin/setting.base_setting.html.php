...
<!--      <tr>
      ...
      <tr>
        <th class="paddingT15"> <label for="default_goods_image">默认产品图片:</label></th>
      ...
      <tr>
        <th class="paddingT15"> <label for="default_store_logo">默认企业标志:</label></th>
...
<!--      <tr>
        <th class="paddingT15">显示产品销售量:</th>
