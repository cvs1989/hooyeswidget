...
?>
    <tr class="tatr2">
        ...
        <?php if ($this->_var['data']['reply_content']): ?><div class="store_reply">企业回复&nbsp;:&nbsp;<?php echo htmlspecialchars($this->_var['data']['reply_content']); ?></div><?php endif; ?></td>
        ...
        <td style="width:80px;" class="handler"><a href="javascript:drop_confirm('您确定要删除这些产品咨询吗？','index.php?app=consulting&amp;act=delete&amp;id=<?php echo $this->_var['data']['ques_id']; ?>');" >删除</a></td>
    </tr>
    ...
    <div id="dataFuncs">
        ...
        <?php if ($this->_var['list_data']): ?><div id="dataFuncs">
            ...
            <input class="formbtn batchButton" type="button" value="删除" name="id" uri="index.php?app=consulting&act=delete" presubmit="confirm('您确定要删除这些产品咨询吗？');" />
            </div>
        </div><?php endif; ?>
    </div>
    <div class="clear"></div>
