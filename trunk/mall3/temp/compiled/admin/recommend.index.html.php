...
?>
    <tr class="tatr2">
      ...
      <td class="handler"><a href="index.php?app=recommend&amp;act=edit&amp;id=<?php echo $this->_var['recommend']['recom_id']; ?>">编辑</a> | <a href="javascript:drop_confirm('您确定要删除该推荐类型吗？', 'index.php?app=recommend&amp;act=drop&amp;id=<?php echo $this->_var['recommend']['recom_id']; ?>');">删除</a> | <a href="index.php?app=recommend&amp;act=view_goods&amp;id=<?php echo $this->_var['recommend']['recom_id']; ?>">查看推荐产品</a></td>
    </tr>
    <?php endforeach; else: ?>
    <tr class="no_data">
