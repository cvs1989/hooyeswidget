      ...
      <div class="public">
        <form method="post" enctype="multipart/form-data" id="goods_form">
          ...
          <table class="table_text word_spacing5" style="margin-top:15px">
            <tr>
              <td valign="top"><p>请选择文件: </p></th>
              <td><input type="file" name="csv" id="csv" /> <span class="gray">导入程序默认从第二行执行导入，请保留CSV文件第一行的标题行</span></td>
            </tr>
            <tr>
              <td valign="top">产品分类: </th>
          ...
          <h2 class="title">
            第二步：上传产品图片<label style="display:none" class="error right">OK!</label><a title="close" class="fold <?php if ($this->_var['step'] == 2): ?>span_close<?php else: ?>span_open<?php endif; ?>"></a>
          </h2>
