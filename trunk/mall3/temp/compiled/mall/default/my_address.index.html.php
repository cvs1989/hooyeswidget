...
?>
                    <?php if (($this->_foreach['v']['iteration'] == $this->_foreach['v']['total'])): ?><tr class="line_bold tr_align"><?php else: ?><tr class="line tr_align"><?php endif; ?>
                        ...
                        <td> <a href="#" ectype="dialog" dialog_id="my_address_edit" dialog_title="编辑地址" dialog_width="700" uri="index.php?app=my_address&act=edit&addr_id=<?php echo $this->_var['address']['addr_id']; ?>" class="edit1 float_none">编辑</a>
