                ...
                <table>
                    ...
                    <tr class="line_bold">
                        ...
                        <th class="align1" colspan="7">
                            ...
                            <a href="###" class="delete" uri="index.php?app=my_favorite&act=drop&type=store" name="item_id" presubmit="confirm('您确定要删除它吗？')" ectype="batchbutton">删除</a>
                        </th>
                    </tr>
                    <?php endif; ?>
...
?>
                    ...
                    <?php endforeach; else: ?>
                    <tr>
                        <td colspan="6" class="member_no_records">没有符合条件的企业</td>
                    </tr>
