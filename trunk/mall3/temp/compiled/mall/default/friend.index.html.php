            ...
            <div class="public table">
                <div class="my_friend">
                    ...
                    <div class="all_btn all_bg_up">
                        ...
                        <a href="###" class="note" uri="index.php?app=message&amp;act=send" name="to_id" ectype="batchbutton">短消息</a>
                        <a href="###" class="delete" uri="index.php?app=friend&act=drop" name="user_id" presubmit="confirm('您确定要删除它吗？')" ectype="batchbutton">删除</a>
                    </div>
                    <?php endif; ?>                    
