            ...
            <form method="post" enctype="multipart/form-data" id="my_store_form">
                    <div class="setup">
                        <div class="photo relative1">
                            ...
                            <span class="explain">此处为您的企业标志，将显示在企业信息栏里建议尺寸100*100像素</span>
                        </div>
                        <div class="photo relative2">
                            ...
                            <b>
                                ...
                                <div class="txt">更换企业条幅</div>
                            </b>
                            <span class="explain">此处为您的企业条幅，将显示在企业导航上方的banner位置，建议尺寸1000*120像素</span>
                        </div>
                        <div class="clear"></div>
                    </div>
                    <div class="setup info shop">
                        ...
                        <table style="width: 100%">
                            ...
                            <?php endif; ?>
                            <tr>
                                <th class="width2">企业名称:</th>
                                <td>
                                    <p class="td_block"><input type="text" class="text width_normal" name="store_name" value="<?php echo htmlspecialchars($this->_var['store']['store_name']); ?>"/><label class="field_notice">企业名称</label></p>
                                    <b class="padding1">*</b><a href="<?php echo url('app=store&id=' . $this->_var['store']['store_id']. ''); ?>" target="_blank" class="btn1">我的企业首页</a>
                                </td>
                            </tr>
                            <tr>
                                <th>所在地区:</th>
                            ...
                            <tr>
                                  <th>MSN在线通:</th>
                                  <td><?php if ($this->_var['store']['im_msn']): ?><?php echo htmlspecialchars($this->_var['store']['im_msn']); ?> <a target="_blank" href="<?php echo url('app=my_store&act=drop_im_msn'); ?>">注销</a><?php else: ?><a target="_blank" href="<?php echo $this->_var['msn_active_url']; ?>">激活我的msn账号</a><span class="padding1">激活后将显示在企业信息栏里</span><?php endif; ?></td>
                             </tr>
                             <tr>
                                <th class="align3">企业简介:</th>
...
?>
                                        ...
                                        <input type="hidden" name="file_id[]" value="<?php echo $this->_var['file']['file_id']; ?>">
                                            ...
                                            <img src="<?php echo $this->_var['site_url']; ?>/<?php echo $this->_var['file']['file_path']; ?>" width="50" height="50" alt="<?php echo htmlspecialchars($this->_var['file']['file_name']); ?>" title="<?php echo htmlspecialchars($this->_var['file']['file_name']); ?>" />
                                                <p class="operation">
                                                    <a href="###" class="cut_in" ectype="insert_editor" ecm_title="插入编辑器"></a>
