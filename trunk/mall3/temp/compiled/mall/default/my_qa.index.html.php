                ...
                <table>
                    ...
                    <tr class="line_bold">
                        ...
                        <th class="align1" colspan="3">
                            ...
                            <a href="#" class="delete" ectype="batchbutton" uri="index.php?app=my_qa&amp;act=drop" name="id" presubmit="confirm('您确定要删除这些咨询吗')">删除</a>
                        </th>
                    </tr>
                    <?php endif; ?>
...
?>
                    <tr class="bgcolor">
                        ...
                        <td style="width:130px">
                            ...
                            <?php if ($this->_var['my_qa_list']['reply_content'] == ''): ?><a href="#" class="add1_ico" ectype="dialog" dialog_id="my_qa_reply" dialog_title="回复咨询" dialog_width="400" uri="index.php?app=my_qa&amp;act=reply&amp;ques_id=<?php echo $this->_var['my_qa_list']['ques_id']; ?>">回复</a>
                            <?php else: ?>
                             <a href="#" class="add1_ico" ectype="dialog" dialog_id="my_qa_edit_reply" dialog_title=" 编辑回复" dialog_width="400" uri="index.php?app=my_qa&amp;act=edit_reply&amp;ques_id=<?php echo $this->_var['my_qa_list']['ques_id']; ?>"> 编辑回复</a>                           
                            <?php endif; ?>
                        </td>
                    </tr>
                    <tr>
