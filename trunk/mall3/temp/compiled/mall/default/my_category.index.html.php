                    ...
                    <tr class="line_bold" >
                        ...
                        <th class="align1" colspan="4">
                           <label for="all"> <span class="all">全选</span> </label>
                            <a href="#" class="delete" ectype="batchbutton" uri="index.php?app=my_category&act=drop" name="id" presubmit="confirm('删除该分类将会同时删除该分类的所有下级分类，您确定要删除吗')">删除</a>
                        </th>
                    </tr>
...
?>
                <tr class="line<?php if (($this->_foreach['v']['iteration'] == $this->_foreach['v']['total'])): ?> last_line<?php endif; ?>" ectype="table_item" idvalue="<?php echo $this->_var['gcategory']['cate_id']; ?>">
                    ...
                    <td class="padding5">
                        <?php if ($this->_var['gcategory']['layer'] < 2): ?>
                         <a href="#" ectype="dialog" dialog_width="480" dialog_title="新增下级" dialog_id="my_category_add" uri="index.php?app=my_category&amp;act=add&amp;pid=<?php echo $this->_var['gcategory']['cate_id']; ?>" class="add1_ico">新增下级</a>
                        <?php endif; ?>
                ...
                <tr>
                    ...
                    <th colspan="4"><p class="position1"><label for="all2"><span class="all">全选</span></label>
                     <a href="###" ectype="batchbutton" class="delete" uri="index.php?app=my_category&act=drop" name="id" presubmit="confirm('删除该分类将会同时删除该分类的所有下级分类，您确定要删除吗')">删除</a></p></td>
                </tr>
                <?php endif; ?>
                </table>
            </div>
