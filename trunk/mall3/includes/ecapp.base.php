...
define('SIZE_GOODS_IMAGE', '2097152');   // 产品大小限制2M
define('SIZE_STORE_LOGO', '20480');      // 企业LOGO大小限制2OK
define('SIZE_STORE_BANNER', '1048576');  // 企业BANNER大小限制1M
define('SIZE_STORE_CERT', '409600');     // 企业证件执照大小限制400K
define('SIZE_STORE_PARTNER', '102400');  // 企业合作伙伴图片大小限制100K
...
class BaseVisitor extends Object
{
    ...
    function _get_detail()
    {
        ...
        /* 如果拥有企业，则默认管理的企业为自己的企业，否则需要用户自行指定 */
        if ($detail['store_id'] && $detail['state'] != STORE_APPLYING) // 排除申请中的企业
        {
