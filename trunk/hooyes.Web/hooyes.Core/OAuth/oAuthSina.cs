    ...
    public class oAuthSina : oAuthBase
    {
        ...
        public string Token { 
            get {
                ...
                {
                    return MemCache.Get("_token").ToString();
                }
                else
                {
                    return _token;
            ...
            set {
                _token = value;
                MemCache.Save("_token", value);
            }
        }
        public string TokenSecret {
            get {
                if (MemCache.Get("_tokenSecret") != null)
                {
                    return MemCache.Get("_tokenSecret").ToString();
                }
                else
                {
                    return _tokenSecret;
            ...
            MemCache.Save("_tokenSecret", value);
            }
        }
        public string User_id
        {
            get
            {
                ...
                {
                    return MemCache.Get("_user_id").ToString();
                }
                else
                {
                    return _user_id;
