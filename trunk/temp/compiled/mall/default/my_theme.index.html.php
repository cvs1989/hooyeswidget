            ...
            <div class="public">
                ...
                <div class="information_index">
                    <div class="templet">
                        ...
                        <div class="txt">
                            <p>企业名称:<span><?php echo htmlspecialchars($this->_var['store']['store_name']); ?></span><a href="<?php echo url('app=store&id=' . $this->_var['id']. ''); ?>" target="_blank" class="btn">企业首页</a></p>
