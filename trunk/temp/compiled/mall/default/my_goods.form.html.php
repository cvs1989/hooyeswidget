...
?>
                                ...
                                <div class="upload_btn">
                                    <div class="upload" id="open_uploader"><b class="hide">上传产品图片</b></div>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <div class="arrange">
                                            <div class="box_arr" ectype="no_spec"  style="display: none;">
                                                ...
                                                <p class="pos_txt">您最多可以添加两种产品规格（如：颜色，尺码）如产品没有规格则不用添加</p>
                                            </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="arrange">
                                            ...
                                            <span class="gray">被推荐的产品会显示在企业首页</span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
