        ...
        <div class="shop_list">
            ...
            <div class="search_bar">
                <form id="search" method="GET" action="index.php">
                    ...
                    <span class="display_span">企业名称</span><input class="table_text" type="text" name="keyword" value="<?php echo htmlspecialchars($this->_var['query']['keyword']); ?>" />
                    <span class="display_span">企业联系人</span><input class="table_text" type="text" name="user_name" value="<?php echo htmlspecialchars($this->_var['query']['user_name']); ?>" />
            ...
            <table>
                <tr>
                    <th class="align1">企业</th>
                    <th>产品数量</th>
                    <th class="width2">企业联系人</th>
