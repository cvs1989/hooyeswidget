...
<div id="content">
    ...
    <div id="right">
        ...
        <ul class="user_menu">
            ...
            <li><a class="normal" href="<?php echo url('app=goods&id=' . $this->_var['goods']['goods_id']. ''); ?>#module"><span>产品详情</span></a></li>
            <li><a class="active" href="<?php echo url('app=goods&act=comments&id=' . $this->_var['goods']['goods_id']. ''); ?>#module"><span>产品评论</span></a></li>
