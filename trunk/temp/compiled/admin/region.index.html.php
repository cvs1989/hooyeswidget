             ...
             if(data)
             {
                 ...
                 for(var i = 0; i < res.length; i++)
                 {
                     ...
                     str+="<tr class='"+pid+" row"+id+"'><td class='align_center w30'><input type='checkbox' class='checkitem' value='" + res[i].region_id + "'></td>"+
                        ...
                        "<td class='align_center'><span ectype='inline_edit' fielname='sort_order' fieldid='" + res[i].region_id + "' datatype='pint' maxvalue='255' title='editable' class='editable'>" + res[i].sort_order + "</span></td>"+
...
?>
        <tr class="">
            ...
            <td class="align_center"><span ectype="inline_edit" fieldname="sort_order" fieldid="<?php echo $this->_var['region']['region_id']; ?>" datatype="pint" maxvalue="255" title="editable" class="editable"><?php echo $this->_var['region']['sort_order']; ?></span></td>
            <td class="handler">
            <span>
