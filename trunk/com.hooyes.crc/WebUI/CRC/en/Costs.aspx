          ...
          <!--#include file="PageNavigation.html"-->
            <table width="65%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                ...
                <td width="93%" class="title-1">- CRC 2010 &gt;&gt; Conference 
                  &gt;&gt; Costs &amp; Payment</td>
              </tr>
            </table>
            <hr>
            <!--中心主体内容 开始-->
            <p class="text">Registration fee is <strong>USD 400/person</strong> 
              (including buffet lunch and dinner, conference documentation, factory 
              visit, refreshment, gift, and so on.)</p>
            <p class="text"> <em>Note: Registration fee does not include accommodation. 
              Please scan the recommended hotels if you need.</em></p>
            <p class="text">&nbsp;</p>
            <p class="text">&nbsp;</p>
            <p class="text">&nbsp;</p>
            <p class="text">&nbsp;</p>
