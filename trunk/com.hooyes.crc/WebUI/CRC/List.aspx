<%@ page language="C#" enableviewstate="false" autoeventwireup="true" inherits="CRC_List" CodeFile="List.aspx.cs" %>
...
<table width="755" border="0" cellpadding="0" cellspacing="0">
          ...
          <!--#include file="PageNavigation.html"-->
            <table width="60%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                ...
                <td width="93%" class="title-1">- CRC 2010 &gt;&gt; 最新报名</td>
              </tr>
            </table>
            <hr>
            <!--中心主体内容 开始-->
    ...
    <div class="CommonDiv CenterPart CenterPart"  >
              ...
              <div class="CommonDiv CenterPart CenterPart"><span class="text"> 
                <img src="img/magnifier.gif" width="18" height="20" /> 输入关键字： 
