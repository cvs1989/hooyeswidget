...
return array (
  'version' => '1.0',
  'subject' => '{$site_name}提醒:企业{$order.seller_name}确认收到了您的货款，交易完成！',
  'content' => '<p>尊敬的{$order.buyer_name}:</p>
<p style="padding-left: 30px;">与您交易的企业{$order.seller_name}已经确认收到了您的货到付款订单{$order.order_sn}的付款，交易完成！您可以到用户中心-&gt;我的订单中对该交易进行评价。</p>
