...
*/
$LangRouter="chs";
$LangArray=array("chs","en");
if(isset($_COOKIE["LangCooike"])){
   $LangRouter=$_COOKIE["LangCooike"];
}
if(isset($_GET["lang"])){
      if(in_array($_GET["lang"],$LangArray)){
	  $LangRouter=$_GET["lang"];
	  setcookie("LangCooike",$LangRouter);
	  }
}
return array (
  'SITE_URL' => 'http://referral.dawnark.com/mall3',
  'DB_CONFIG' => 'mysql://dmc091883:hooyescrd2010@dmc-09.hichina.com:3306/dmc091883_db',
  'DB_PREFIX' => 'h_',
  'LANG' => $LangRouter,
  'COOKIE_DOMAIN' => '',
  'COOKIE_PATH' => '/',
  'ECM_KEY' => 'dd3a8adaad81e10fb246ba60184f73bd',
  'MALL_SITE_ID' => 'EMKCFQfb47nlQLLh',
  'ENABLED_GZIP' => 0,
  'DEBUG_MODE' => 0,
